...
def train_and_visualize(env, episodes=5):
    pygame.init()
...
def draw_grid(screen, env, grid_size, cell_size, images):
    # Draw the grid and the elements
    ...
    # Draw the dog last to make sure it's always on top
